...
await page.waitForTimeout(350)
const form = page.locator('.mobile-slide').nth(7).locator('form')
...
if (!(await page.locator('.mobile-slide').nth(7).locator('.form-status--success').isVisible())) throw new Error('Local success state did not appear')
